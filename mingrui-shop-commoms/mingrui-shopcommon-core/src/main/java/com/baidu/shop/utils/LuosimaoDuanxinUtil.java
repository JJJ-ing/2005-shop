...
public class LuosimaoDuanxinUtil {
    ...
    //短信平台的APIkey
    private static final String DUANXIN_API_KEY = "key-153573c92f7236c977993e9c082474e0";//需要使用自己的APIkey
    private static final String SPEAK_API_KEY = "key-bf8baf0ef5b3fca2208837baa4cb8c94";//需要使用自己的APIkey
